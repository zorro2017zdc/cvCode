...
for i=1:length(corrPtIdx)
    plot(matchLoc1(corrPtIdx(i),1),matchLoc1(corrPtIdx(i),2),'go','LineWidth',2);
    plot(matchLoc2(corrPtIdx(i),1)+size(img1,2),matchLoc2(corrPtIdx(i),2),'go','LineWidth',2);
    plot([matchLoc1(corrPtIdx(i),1) matchLoc2(corrPtIdx(i),1)+size(img1,2)],[matchLoc1(corrPtIdx(i),2) matchLoc2(corrPtIdx(i),2)],'g-');
end
